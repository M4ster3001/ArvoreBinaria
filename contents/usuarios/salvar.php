        ...
        <main>
            <form id="frm_usuario" onsubmit="return false;" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-control">
                    ...
                    <input type="password" id="pwd_senha" name="pwd_senha" onchange="ChecarSenha()" required />
                </div>

                <div class="form-control">
                    <label for="conf_pwd_senha" class="lb_conf_senha">Confirmar a senha</label>
                    <input type="password" id="conf_pwd_senha" name="conf_pwd_senha" onchange="ChecarSenha()" required />
                </div>
